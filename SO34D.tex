...
In this chapter, we construct explicit models which realize the interacting bosonic analog of the topological insulator, once again by binding charges to point topological defects. However, in this three-dimensional case the relevant point topological defects are called hedgehogs. 
